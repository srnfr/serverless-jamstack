...
const getInventory = async () => {
  let results = await axios.get('https://faas-lon1-917a94a7.doserverless.co/api/v1/web/fn-cb709af2-805f-4377-a8c9-af89cff51554/cloud/getCoffee');
...
const subscribeHandler = async function() {
  ...
  let emailUrl = "https://faas-lon1-917a94a7.doserverless.co/api/v1/web/fn-cb709af2-805f-4377-a8c9-af89cff51554/cloud/postEmail" + "?email=" + email;
